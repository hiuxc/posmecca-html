  ...
  <div class="inner">
    ...
    <nav id="gnb">
      ...
      <ul>
        ...
        <li><a href="../htmlreference.html" aria-label="Reference">Reference</a></li>
        <li><a href="../htmlesg_environment.html" aria-label="ESG">ESG</a></li>
        <li><a href="../htmlcs_center_info.html" aria-label="CS Center">CS Center</a></li>
        <li><a href="../htmlaboutus_greeting.html" aria-label="About us">About us</a></li>
      </ul>
    </nav>
  </div>
</header>`;
